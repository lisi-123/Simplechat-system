...
将刚才创建的的机器人拉入群中，给它管理员权限，并手动给bot打开“管理话题”的权限（默认的管理员权限不够，没有管理话题权限）

<img src="./0.png" alt="Editor" width="600px">

注意！！！必须开启话题权限，项目完全依赖话题权限启动，不开话题，不给bot开启“管理话题”一定用不了。
...
在cf的规则里添加一个 Origin Rules（源服务器规则）
...
youxuan.example.xyz：cname一个cloudflare优选域名（比如 ct.090227.xyz ），不开小黄云
...
免责申明：使用过程中有问题直接把代码丢给ai，本人完全不懂代码
